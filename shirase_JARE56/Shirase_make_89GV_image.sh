...
ifile="${idir0}/%V/%Y%m/GW1AM2%Y%m%dA_110TB%V%P.dat"
vars=("89GV" )
ofile="/var/www/vishop/data/%Y%m/AM2SI%Y%m%d89GVM_%P.png"
yymmdds=20141001
yymmdde=100000000
gmtscript="/home/shirase/VENUS/gmt4_make_89GV_image.sh"
cd ${gmtscript%/*}
script="./${gmtscript
i=0
while [ $i -lt ${
