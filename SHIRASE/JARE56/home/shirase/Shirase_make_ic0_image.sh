...
vars=("IC0")
ofile="/var/www/vishop/data/%Y%m/AM2SI%Y%m%dIC0M_%P.png"
yymmdds=20141001
yymmdde=100000000
gmtscript="/home/shirase/VENUS/gmt4_make_ic0_image.sh"
cd ${gmtscript%/*}
script="./${gmtscript
i=0
while [ $i -lt ${
...
echo "var start  = {"y":2012,"m":07,"d":24};" > /var/www/vishop/js/param.js
echo "var latest  = {"y":$yy,"m":$mm,"d":$dd};" >> /var/www/vishop/js/param.js
