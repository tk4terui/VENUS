...
convert $PNG -rotate +90 \
               ...
               ColorScale_89G.png -gravity southwest -composite \
               -gravity south -splice 0x150 -alpha off $OUT
mv $OUT AM2SI${i:0:8}89GVM_${i:8:2}.png
rm $TXT $EPS $PNG
done
