...
vars=("IC0")
ofile="/var/www/shirase/data/%Y%m/AM2SI%Y%m%d%R_IC0%S_%P.png"
yymmdds=20181001
yymmdde=100000000
poleALL="SP"
adALL="A"
...
echo "var start  = {"y":2017,"m":12,"d":01};" > /var/www/shirase/js/param.js
echo "var latest  = {"y":$yy,"m":$mm,"d":$dd};" >> /var/www/shirase/js/param.js
